...
.contour-label-inline span {{
  display: inline-block;
  color: rgba(107, 52, 16, 0.25);
  font-size: 10px;
  font-weight: bold;
  text-shadow: 1px 0 1px rgba(255,255,255,0.6), -1px 0 1px rgba(255,255,255,0.6),
               0 1px 1px rgba(255,255,255,0.6), 0 -1px 1px rgba(255,255,255,0.6);
  line-height: 1;
  white-space: nowrap;
}}
